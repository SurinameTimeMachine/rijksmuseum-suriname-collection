    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
        ...
        <div className="lg:col-span-3">
          <div className="relative aspect-4/3 rounded-xl overflow-hidden bg-(--color-cream-dark) border border-(--color-border)">
            <ObjectImage
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-4 py-2.5 bg-(--color-charcoal) text-white text-sm font-medium rounded-lg hover:bg-(--color-charcoal-light) transition-colors"
          >
    ...
    <div>
      ...
      <div className="flex flex-wrap gap-1.5">
        {values.map((v) => (
          <span
            key={v}
            className="inline-block px-2.5 py-1 bg-(--color-cream-dark) rounded-md text-xs text-(--color-charcoal-light)"
          >
            {v}
          </span>
        ))}
